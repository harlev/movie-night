        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center sm:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-lg text-[var(--color-text-muted)] hover:text-[var(--color-text)] hover:bg-[var(--color-surface-elevated)]"
            >
          ...
          <div className="pt-4 pb-3 border-t border-[var(--color-border)]">
            ...
            <div className="mt-3 px-2">
              <form action={logout}>
                <button
                  type="submit"
                  className="block w-full text-left px-3 py-2 rounded-lg text-base font-medium text-[var(--color-text-muted)] hover:text-[var(--color-text)] hover:bg-[var(--color-surface-elevated)]"
                >
                  Logout
                </button>
              </form>
