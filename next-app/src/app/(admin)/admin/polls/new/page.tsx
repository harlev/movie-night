  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-[var(--color-text)] mt-2">Create Quick Poll</h1>
      </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g., Friday Movie Night Pick"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Add any notes or context for voters..."
              />
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-[var(--color-text-muted)] mt-1">
                Voters will rank their top N choices. Rank 1 gets N points, rank 2 gets N-1 points, etc.
              </p>
            </div>
