...
create unique index if not exists budgets_single_open_idx on public.budgets(status) where status = 'open';
...
-- ============================================================
-- Migration: 20260301_add_site_settings.sql
-- ============================================================
...
-- ============================================================
-- Migration: 20260316_add_feedback.sql
-- ============================================================
...
-- ============================================================
-- Migration: 20260321_feedback_self_manage.sql
-- ============================================================
